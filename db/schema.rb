...
ActiveRecord::Schema.define(version: 20170924023554) do
  ...
  create_table "offer_deliveries", force: :cascade do |t|
    t.string   "product"
    t.decimal  "price"
    t.text     "message"
  ...
  create_table "request_deliveries", force: :cascade do |t|
    t.string   "product"
    t.decimal  "price"
    t.text     "message"
    t.integer  "customer_id"
